...
#Region "Variables y objetos"
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Public Shared CONNECTION_STRING_AsistenciaII As String
...
#Region "Consultas y comandos"
        ...
        End Sub
        '////////////////////////////////////////////////////////////////////////////////
        Public Function Consultas_Query_Datatable(ByVal query As String, Optional ByVal timeout As Integer = 0) As DataTable
            ...
            Catch ex As Exception
                ...
                errorDesc = ex.Message
                hayError = True
                Logs.LogError("AccesoDatos.vb", "Consultas_SP_Datatable", ex.Message, query)
            Finally
                Desconectar()
                adapter.Dispose()
            End Try
